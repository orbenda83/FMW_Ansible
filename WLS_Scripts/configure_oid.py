...
cmo.createAuthenticationProvider(providerName, 'weblogic.security.providers.authentication.OracleInternetDirectoryAuthenticator')
...
cmo.setPropagateCauseForLoginException(false)
#cmo.setUseTokenGroupsForGroupMembershipLookup(true)
cmo.setResultsTimeLimit(1000)
cmo.setConnectionRetryLimit(5)
cmo.setConnectTimeout(120)
cmo.setCacheTTL(3600)
cmo.setIgnoreDuplicateMembership(false)
cmo.setConnectionPoolSize(100)
cmo.setCacheSize(4096)
cmo.setParallelConnectDelay(0)
cmo.setKeepAliveEnabled(false)
cmo.setGroupHierarchyCacheTTL(60)
cmo.setMaxGroupHierarchiesInCache(100)
